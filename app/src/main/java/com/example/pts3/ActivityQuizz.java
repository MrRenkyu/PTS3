...
public class ActivityQuizz extends AppCompatActivity {
    ...
    private void setRandomImage(){
        ...
        image2.setImageDrawable(studentManager.getAllStudents().get(nb1).getPhoto().getPicture());
        image3.setImageDrawable(studentManager.getAllStudents().get(nb1).getPhoto().getPicture());
        image4.setImageDrawable(studentManager.getAllStudents().get(nb1).getPhoto().getPicture());
    }
